...
\begin{figure*}[htp]
 \centering
 \subfloat[Image originale]{\includegraphics[scale=0.35]{Images/ea_test_lissage_01}}               
 \subfloat[Masque de peau]{\includegraphics[scale=0.35]{Images/ea_test_lissage_02}}
 \subfloat[Image après lissage]{\includegraphics[scale=0.35]{Images/ea_test_lissage_03}}
...
\begin{figure*}[htp]
 \centering
 \subfloat[Image originale]{ \label{fig:ProfExemple1} \includegraphics[scale=0.35]{Images/ea_test_prof01}}               
 \subfloat[Pixels au fond]{\includegraphics[scale=0.35]{Images/ea_test_prof02}}
 \subfloat[Image après augmentation de la profondeur de champ]{ \label{fig:ProfExemple3}\includegraphics[scale=0.35]{Images/ea_test_prof03}}
...
\paragraph*{}
La figure~\ref{fig:ContExemple} est un exemple de ce que l'on peut obtenir après rehaussement du contraste. Le support est cette fois une image différente par rapport aux modules précédents puisque le contraste n'évoluait que très peu. Nous avons ainsi sélectionné une autre image plus adaptée à la démonstration. En observant le résultat, le contraste offre une gamme de couleurs pour le blanc et le jaune qui sont maintenant plus naturels.
