...
Plus précisément, dans la prochaine phase, nous allons identifier clairement les techniques utilisables. Puis nous concevrons de manière plus formelle la manière de mettre en œuvre la première proposition. À la suite de cela, nous entamerons les développements correspondants.
