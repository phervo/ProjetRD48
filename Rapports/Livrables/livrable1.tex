...
\begin{figure*}[htp]
 \centering
 \subfloat[Visage Original]{\label{fig:IntervalleMasquePeau1_Original}\includegraphics[scale=0.22]{Images/ea_peau_visage2_original}}               
 \subfloat[Masque de peau avec anciens intervalles \cite{Chai1999}]{\label{fig:IntervalleMasquePeau1_Ancien}\includegraphics[scale=0.22]{Images/ea_peau_visage2_ancien_intervalle}}
 \subfloat[Masque de peau avec nouveaux intervalles \cite{Kukharev2004}]{\label{fig:IntervalleMasquePeau1_Nouveau}\includegraphics[scale=0.22]{Images/ea_peau_visage2_nouvel_intervalle}}
...
\begin{equation}
ImageFinale(i,j) = (ImageOriginale + ImageFloue(i,j)) * CoefficientOpacite
\label{CalculPeau}
\end{equation}
